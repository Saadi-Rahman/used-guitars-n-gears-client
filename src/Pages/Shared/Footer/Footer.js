    ...
    return (
        <footer className='mt-20' style={{  
            ...
            <div className='footer p-12'>
                <div>
                    <span className="text-lg text-white font-bold">Services</span> 
                ...
                <div>
                    <span className="text-lg text-white font-bold">Company</span> 
                ...
                <div>
                    <span className="text-lg text-white font-bold">Legal</span> 
