    ...
    return (
        <div className="hero px-2 md:px-8 lg:px-16 mb-4">
            <div className="hero-content flex-col lg:flex-row-reverse gap-14">
                ...
                <div>
                    <h4 className='text-lg text-primary font-bold uppercase'>About Us</h4>
                    <h2 className='text-2xl text-secondary font-semibold mb-4'>Used Guitars N Gears is a retail musical instrument store located in Catonsville, "Music City" Maryland. </h2>
